  ...
  return (
    <div className="p-6 overflow-y-auto flex-1 flex flex-col relative bg-light-bg dark:bg-dark-bg transition-colors duration-200">
      ...
      <div className="mb-6 border-beam-container rounded-md">
        <div className="border-beam-inner bg-light-card dark:bg-[#121212] border border-[#E9ECEF] dark:border-white/5 rounded-md p-4 flex items-center justify-between shadow-sm dark:shadow-lg transition-colors duration-200 hover-micro-gradient">
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-3">
              ...
              <div className="flex bg-gray-100 dark:bg-[#0A0A0A] p-1 rounded border border-[#E9ECEF] dark:border-white/5">
        ...
        {selectedReview && (
          <>
            ...
            <motion.aside 
              ...
              className="fixed top-0 right-0 h-full w-full sm:w-[500px] bg-light-card dark:bg-[#121212] border-l border-[#E9ECEF] dark:border-white/5 shadow-[-20px_0_50px_rgba(0,0,0,0.1)] dark:shadow-[-20px_0_50px_rgba(0,0,0,0.5)] z-40 flex flex-col"
            >
              <div className="flex items-center justify-between p-6 border-b border-[#E9ECEF] dark:border-white/5 bg-gray-50 dark:bg-[#0A0A0A]/50 transition-colors duration-200">
                <div className="flex items-center gap-3">
              ...
              <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-6">
                <div className="bg-gray-50 dark:bg-[#0A0A0A] border border-[#E9ECEF] dark:border-white/5 p-4 rounded-md transition-colors duration-200">
                ...
                {selectedReview.logs && (
                  <div className="mt-2 border-t border-[#E9ECEF] dark:border-white/5 pt-4">
                    ...
                    {selectedReview.logs.map((log, idx) => (
                      <div key={idx} className="bg-gray-50 dark:bg-[#0A0A0A] border border-[#E9ECEF] dark:border-white/5 p-3 rounded text-[11px] font-mono text-gray-500 dark:text-gray-400 flex flex-col gap-1 transition-colors duration-200">
