  ...
  return (
    <div className="p-6 overflow-y-auto flex-1 flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* AI Token Usage Card */}
        <div className="bg-light-surface dark:bg-[#121212] border border-light-border dark:border-white/5 rounded-md shadow-sm dark:shadow-lg p-6 hover-micro-gradient transition-colors duration-200">
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="w-full bg-gray-200 dark:bg-[#0A0A0A] rounded-full h-2 border border-transparent dark:border-white/5">
      ...
      <div className="bg-light-surface/50 dark:bg-[#121212]/50 border border-light-border dark:border-white/5 rounded-md shadow-sm dark:shadow-lg p-6 relative overflow-hidden">
        <div className="absolute inset-0 bg-white/40 dark:bg-black/40 backdrop-blur-[2px] z-10 flex items-center justify-center">
          <div className="flex items-center gap-2 bg-white dark:bg-[#121212] border border-light-border dark:border-white/10 px-4 py-2 rounded-full shadow-lg dark:shadow-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 opacity-50">
          {[1, 2, 3].map(i => (
            <div key={i} className="h-24 bg-gray-100 dark:bg-[#0A0A0A] border border-light-border dark:border-white/5 rounded-md"></div>
          ))}
        </div>
      </div>
    </div>
